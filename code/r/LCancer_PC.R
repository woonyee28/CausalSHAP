...
# Load the dataset
dataset <- read_excel("C:/Users/snorl/Desktop/FYP/dataset/lung_cancer_predicted_probabilities.xlsx")

# Correct Group encoding

# Specify columns for X (features)
X_columns <- c('sex', 'age_interview', 'BMI', 'telomere length', 'smoke_never(0)_ex(1)_current(2)', 'Leisure screen time', 'alcohol_0_12', 'ahei2010score', 'SBP', 'DBP', 'shortsleepvsnormal', 'longsleepvsnormal', 'prevalent diabetes', 'pgs000070', 'pgs000721', 'Prob_Class_1')
